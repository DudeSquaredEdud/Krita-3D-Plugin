...
class GLBLoader:
    ...
    def load_from_bytes(self, data: bytes) -> GLBData:
        ...
        images = self._parse_images(json_data.get('images', []), binary_buffer, buffer_views)
    ...
    def _parse_images(self, images_data: List[Dict], binary_buffer: bytes,
        ...
        for img in images_data:
            ...
            if 'bufferView' in img:
                ...
                if buffer_view_idx < len(buffer_views):
                    ...
                    data = binary_buffer[start:end]
                else:
                    data = b''
            else:
                # TODO: External URI - not supported for now
                data = b''
