...
class SceneTab(QWidget):
    ...
    reload_from_project_requested = pyqtSignal() 
    ...
    def set_project_scene(self, project_scene: 'ProjectScene'):
        ...
        project_scene.add_callback('scene_saved', self._on_scene_saved)
        project_scene.add_callback('scene_loaded', self._on_scene_loaded)
        project_scene.add_callback('scene_changed', self._on_scene_changed)
