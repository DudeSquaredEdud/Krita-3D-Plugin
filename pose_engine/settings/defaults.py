...
DEFAULT_KEYBOARD_SHORTCUTS = {
    ...
    'sync_to_layer': (Qt.Key_S, Qt.ControlModifier | Qt.ShiftModifier),
...
DEFAULT_GIZMO_SETTINGS = {
    ...
    # Display scale - on-screen size of gizmos and joints, independent of FOV
    'display_scale': 0.05,
    'joint_display_scale': 0.15,
